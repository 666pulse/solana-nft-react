...
export default function IssueNFT({ cluster }) {
  ...
  return (
    <FlexBox>
      ...
      <FormBox>
        <Form labelCol={{ span: 4 }} wrapperCol={{ span: 20 }} form={form} name="control-hooks" onFinish={onFinish}>
        ...
        <AlertBox>{nftUrl && <Alert message="NFT Created" description={nftUrl} type="success" showIcon />}</AlertBox>
      </FormBox>
    </FlexBox>
  );
}
